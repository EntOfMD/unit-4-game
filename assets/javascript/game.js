...
var fx = {
  ...
  appInit: () => {
    ...
    if (values.current_value === 0) {
      DOMs.currentValue.addClass('small').append('Click a crystal to start');
    } else {
...
$(function() {
  ...
  //Sometimes this get error'd and won't assign new value to the buttons if you keep on spamming it, it could be prevented by putting this inside the displayNumOnClick, and let it calc from there, but I'm out of time..
